...
if __name__ == "__main__":
    ...
    ".format(
        MODEL_FILE, Token_FILE, mode, control_mode, tuning_mode, gen_dir, eval_split
    )
    ...
    if not submit_job:
        ...
        full_command = "nlprun -a lisa-base-torch -g 1 -n {} -x jagupard4,jagupard5,jagupard6,jagupard7,jagupard8,jagupard28,jagupard29 '{}'".format(
            name, COMMANDLINE
        )
        print(full_command)
