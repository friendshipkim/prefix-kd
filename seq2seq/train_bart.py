...
if __name__ == "__main__":
    ...
    if args.mode == "e2e":
        ...
        TRAIN_FILE = (
            "/u/scr/xlisali/WebNLG/webnlg-dataset/webnlg_challenge_2017/train.json"
        )
        TEST_FILE = (
            "/u/scr/xlisali/WebNLG/webnlg-dataset/webnlg_challenge_2017/dev.json"
        )
        ...
        cnndm_app = (
            " --max_source_length {} --max_target_length {} --val_max_target_length {} "
            "--test_max_target_length {} ".format(
                max_source_length,
                max_target_length,
    ...
    app = (
        ...
        "--mid_dim {} --use_dropout {} --prefix_dropout {} ".format(
            args.optim_prefix,
            args.preseqlen,
            args.prefix_mode,
            args.format_mode,
    ...
    if (
        args.mode == "xsum"
        or args.mode == "xsum_news"
        or args.mode == "xsum_news_sport"
    ):
        app += xsum_app
    ...
    if args.do_train == "yes":
        ...
        if args.tuning_mode == "finetune":
            ...
            Model_FILE = (
                args.prefix_model_path + "_decode_eval" + "_{}".format(args.length_pen)
            )
            print("writing the decoded results to {}".format(Model_FILE))
            COMMANDLINE = (
                "python finetune.py "
    ...
    # #
        ...
        if args.use_big == "no":
            full_command = "nlprun -a lisa_apex_latest -g 1 -n {} -x jagupard4,jagupard5,jagupard6,jagupard7,jagupard8 '{}'".format(
                Model_FILE, COMMANDLINE
            )
        elif args.use_big == "yes":
            full_command = (
                "nlprun -p high -a lisa_apex_latest -g 1 -n {} -x jagupard4,jagupard5,jagupard6,jagupard7,jagupard8,"
                ...
                "jagupard24,jagupard25,jagupard28,jagupard29 '{}'".format(
                    Model_FILE, COMMANDLINE
                )
            )
            ...
            full_command = (
                "nlprun -p high -a lisa_apex_latest2 -g 1 -n {} -x jagupard4,jagupard5,jagupard6,jagupard7,jagupard8,"
                "jagupard10,jagupard11,jagupard12,jagupard13,jagupard14,jagupard15,jagupard16,jagupard17,jagupard18,"
                "jagupard19,jagupard20,jagupard21,jagupard22,jagupard23,"
                "jagupard24,jagupard25,jagupard26,jagupard27 '{}'".format(
                    Model_FILE, COMMANDLINE
                )
            )
        else:
            full_command = "nlprun -a lisa_apex_latest -m jagupard26 -p high -g 1 -n {} '{}'".format(
                Model_FILE, COMMANDLINE
            )
        print(full_command)
